...
<div class="flex items-center">
	<div class="m-10 justify-center rounded-xl w-max bg-slate-500 p-5 text-white">
		<h2 class="text-center mb-5 text-4xl font-bold">{user.name.title} {user.name.first} {user.name.last}</h2>
